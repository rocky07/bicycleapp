                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="custom-content">
                            <h3>FREE DELIVERY IN KOCHI</h3>
                            <p>All Kerala delivery available</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <ul class="product-event-content">
                                ...
                                <li>
                                    <h3><a href="single-product.html"><c:out value="${product.title}"/></a></h3>
                                    ...
                                    <span class="event-price"><c:out value="${product.price}"/></span>
                                </li>
