...
<head>
    ...
    <link href="<c:url value='/resources/fonts/lovelo/stylesheet.css'/>" rel='stylesheet' type='text/css'>
    ...
    <link href="<c:url value='/resources/rs-plugin/css/settings.css'/>" rel="stylesheet" type='text/css'>
...
<body>
            ...
            <div id="rev_slider_1_1" class="rev_slider fullwidthabanner">
                <ul>
                    <li data-transition="fade" data-slotamount="7" data-masterspeed="700"  data-saveperformance="off" >
                        <!-- MAIN IMAGE -->
                        <img src="images/slider/slider.jpg"  alt="slider"  data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
                        <!-- LAYERS -->
                    ...
                    <li data-transition="fade" data-slotamount="7" data-masterspeed="700"  data-saveperformance="off" >
                        <!-- MAIN IMAGE -->
                        <img src="images/slider/slider31.jpg"  alt="slider31"  data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
                        <!-- LAYERS -->
                    ...
                    <li data-transition="fade" data-slotamount="7" data-masterspeed="700"  data-saveperformance="off" >
                        <!-- MAIN IMAGE -->
                        <img src="images/slider/slider2.jpg"  alt="slider2"  data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
                        <!-- LAYERS -->
                        ...
                        <div class="tab-pane active" id="one_read">
                            <div class="row">
                                <div class="col-md-4 col-sm-6">
                                    ...
                                    <div class="product-item">
                                        <div class="product-thubnail">
                                            <img src="images/product/product1.jpg" alt="product 1" />
                                ...
                                <div class="col-md-4 col-sm-6">
                                    ...
                                    <div class="product-item">
                                        <div class="product-thubnail">
                                            <img src="images/product/product2.jpg" alt="product 2" />
                                            <div class="product-meta">
                                                <a class="add-to-cart" href="shop-cart.html">Add to cart</a>
                                                <span class="quick-view">
                                                    <a href="#">Quick view</a>
                        ...
                        <div class="tab-pane" id="x_road">
                            <div class="row">
                                <div class="col-md-4 col-sm-6">
                                    ...
                                    <div class="product-item">
                                        <div class="product-thubnail">
                                            <img src="images/product/product2.jpg" alt="product 1" />
                                            <div class="product-meta">
                                                <a class="add-to-cart" href="shop-cart.html">Add to cart</a>
                                                <span class="quick-view">
                                                    <a href="#">Quick view</a>
                                ...
                                <div class="col-md-4 col-sm-6">
                                    ...
                                    <div class="product-item">
                                        <div class="product-thubnail">
                                            <img src="images/product/product1.jpg" alt="product 2" />
                                            <div class="product-meta">
                                                <a class="add-to-cart" href="shop-cart.html">Add to cart</a>
                                                <span class="quick-view">
                                                    <a href="#">Quick view</a>
    ...
    <script type='text/javascript' src="<c:url value='/resources/js/off-canvas.js'/>"></script>
    <!--jQuery Countdow-->
    <script type='text/javascript' src="<c:url value='/resources/js/jquery.plugin.min.js'/>"></script>
    <script type='text/javascript' src="<c:url value='/resources/js/jquery.countdown.min.js'/>"></script>
    <!--End Countdow-->
    <script type='text/javascript' src="<c:url value='/resources/js/jquery.parallax-1.1.3.js'/>"></script>
    ...
    <script type='text/javascript' src="<c:url value='/resources/rs-plugin/js/custom-rs.js'/>"></script>
</body>
</html>
